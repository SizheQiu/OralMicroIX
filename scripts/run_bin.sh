...
#metawrap bin_refinement -o BIN_REFINEMENT/A -t 4 -A INITIAL_BIN/A/metabat2_bins/ -B INITIAL_BIN/A/maxbin2_bins/ -C INITIAL_BIN/A/concoct_bins/ -c 90 -x 10
#echo "A bin refine completed"

#metawrap quant_bins -b BIN_REFINEMENT/A/metawrap_90_10_bins -o QUANT_BINS/A -a ASSEMBLY/A/final_assembly.fasta CLEAN_READS/A*fastq
...
metawrap reassemble_bins -o BIN_REASSEMBLY/A -1 CLEAN_READS/ALL_READS/A_1.fastq -2 CLEAN_READS/ALL_READS/A_2.fastq \
	-t 4 -m 64 -c 90 -x 10 -b BIN_REFINEMENT/A/metawrap_90_10_bins
...
#metawrap bin_refinement -o BIN_REFINEMENT/B -t 4 -A INITIAL_BIN/B/metabat2_bins/ -B INITIAL_BIN/B/maxbin2_bins/ -C INITIAL_BIN/B/concoct_bins/ -c 90 -x 10
#echo "B bin refine completed"

#metawrap quant_bins -b BIN_REFINEMENT/B/metawrap_90_10_bins -o QUANT_BINS/B -a ASSEMBLY/B/final_assembly.fasta CLEAN_READS/B*fastq
...
metawrap reassemble_bins -o BIN_REASSEMBLY/B -1 CLEAN_READS/ALL_READS/B_1.fastq -2 CLEAN_READS/ALL_READS/B_2.fastq \
	-t 4 -m 64 -c 90 -x 10 -b BIN_REFINEMENT/B/metawrap_90_10_bins
